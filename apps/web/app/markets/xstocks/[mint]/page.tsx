  ...
  return <div className="asset-page public-asset-page">
    ...
    <div className="asset-layout">
      <div className="asset-primary">
        ...
        <dl className="asset-stats"><div><dt>Indicative token price</dt><dd>{formatUsd(asset.tokenPriceUsd)}</dd></div><div><dt>Classification</dt><dd>{marketLabels[asset.marketType]}</dd></div><div><dt>Underlying symbol</dt><dd>{asset.metadata?.underlyingSymbol ?? "Not specified"}</dd></div><div><dt>Network</dt><dd>Solana mainnet</dd></div></dl>
