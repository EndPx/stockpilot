...
## Discovery exception found during live QA — owner decision confirmed

The full catalog includes VCXx, a listed fund wrapper with private-company exposure. The [issuer's announcement](https://xstocks.com/news/xstocks-and-fundrise-partner-to-tokenize-vcx-fund-unlocking-onchain-exposure-to-leading-private-tech-companies) explicitly describes this exposure; [product evidence](https://assets.backed.fi/products/fundrise-innovation-fund-llc-xstock) binds product ISIN CH1500008755 and underlying US3608521072 to the official API record. Canonical Solana mint: `Xs7UsqobM3EJgMeHwdAbmDBCZH1G5WTCjatpeYcCr8x`.

This exposes a real tension between “all canonical products” and the stronger PreStocks-only private-exposure rule. Fail-closed default: exclude this evidence-backed product from active discovery, while ingesting and counting it in the source audit. Exclusion is bound to mint / issuer ID / underlying ISIN, not its ticker; a rename cannot evade it. The other catalog records remain discoverable. This is an exclusion policy, not a three-stock whitelist or an exhaustive underlying-holdings audit of 1,026 products.

On 2026-09-23 the owner explicitly confirmed: exclude VCXx and other products with proven private exposure; keep the remaining catalog discoverable. The final live run at `2026-09-22T18:43:26Z` ingested 1,026 canonical Solana products and admitted 1,025: 3 evidenced public-equity products and 1,022 generic products. This does not claim an exhaustive private-exposure holdings audit. The live SpaceX xStock SPCXx is also an official issuer product ([source](https://assets.backed.fi/products/spacex-xstock)); it must not be confused by ticker/name with the distinct PreStocks SPACEX asset or treated as a user-created synthetic mint.
